...
@WorkspaceQueryHook(`timelineActivity.groupBy`)
export class TimelineActivityGroupByPreQueryHook
  implements WorkspacePreQueryHookInstance
{
  async execute(
    ...
    return {
      ...args,
      filter: buildScopedFilter('targetCompanyId', scopedCompanyId, args.filter),
    } as ResolverArgs;
  }
}
