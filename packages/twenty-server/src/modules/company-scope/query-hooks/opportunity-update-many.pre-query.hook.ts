...
/**
 * Enforces company scope on opportunity.updateMany operations.
 * Prevents non-root users from updating opportunities belonging to other companies.
 */
@WorkspaceQueryHook(`opportunity.updateMany`)
export class OpportunityUpdateManyPreQueryHook
