...
/**
 * Enforces company scope on opportunity.deleteMany operations.
 * Prevents non-root users from deleting opportunities belonging to other companies.
 */
@WorkspaceQueryHook(`opportunity.deleteMany`)
export class OpportunityDeleteManyPreQueryHook
