...
/**
 * Enforces company scope on person.deleteMany operations.
 * Prevents non-root users from deleting people belonging to other companies.
 */
@WorkspaceQueryHook(`person.deleteMany`)
export class PersonDeleteManyPreQueryHook
